<a id="sellCurrencyContainer"    class="flex items-center justify-center mt-3 gap-2 w-full md:w-5/6"  href="https://www.extravelmoney.com/sell-forex/" target="_blank"  <?php if($widgetType=='mt') echo 'style="display:none;"' ?>>
                            <div class="flex">
