<section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">
                        ...
                        <p class="" style="word-wrap: break-word;background: linear-gradient(26deg, #0E51A0 1.1%, #E3373A 40.49%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">Banglore</p>
                    </h1>



                    <!--rates widget start--><div class="relative shadow-md w-4/5 mx-auto mt-6 ">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 rounded-lg overflow-hidden" style="width: 70%;">
        <thead style="background: linear-gradient(26deg, #0E51A0 -20.1%, #E3373A 90.49%);">
            <tr>
                <th scope="col" class="px-6 py-3 border-b border-gray-200 text-white dark:border-gray-600">
                    Currency
                </th>
                <th scope="col" class="px-6 py-3 border-b border-gray-200 text-white dark:border-gray-600">
                    Rate
        ...
        <tbody>
            <tr class="bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700 text-black">
